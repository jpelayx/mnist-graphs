python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments  10 --slic_method SLIC  
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments  10 --slic_method SLIC  
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments  10 --slic_method SLIC  
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments  10 --slic_method SLIC  
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments  10 --slic_method SLIC  
...
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments  20 --slic_method SLIC  
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments  20 --slic_method SLIC  
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments  20 --slic_method SLIC  
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments  20 --slic_method SLIC  
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments  20 --slic_method SLIC  
...
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments  50 --slic_method SLIC  
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments  50 --slic_method SLIC  
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments  50 --slic_method SLIC  
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments  50 --slic_method SLIC  
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments  50 --slic_method SLIC  
...
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments 100 --slic_method SLIC  
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments 100 --slic_method SLIC  
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments 100 --slic_method SLIC  
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments 100 --slic_method SLIC  
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments 100 --slic_method SLIC  
...
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments 200 --slic_method SLIC  
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments 200 --slic_method SLIC  
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments 200 --slic_method SLIC  
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments 200 --slic_method SLIC  
python3 load_dataset.py --features "avg_color std_deviation_color centroid std_deviation_centroid" --dataset geo_ds --graph_type RAG --n_segments 200 --slic_method SLIC  
