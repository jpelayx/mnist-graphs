...
python3 train-model.py -m GCN --dataset mnist -f GCN/mnist-best-choices                 --n_segments  50 --graph_types RAG --features "avg_color centroid num_pixels std_deviation_centroid std_deviation_color"
