...
python model.py --features "avg_color std_deviation_color centroid std_deviation_centroid avg_color_hsv" --dataset stl10 --quiet  
python model.py --features "avg_color std_deviation_color centroid std_deviation_centroid avg_color_hsv std_deviation_color_hsv" --dataset stl10 --quiet  
